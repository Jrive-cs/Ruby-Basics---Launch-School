...
#TEST - puts calculate_balance({ income: [100], expenses: [50] }) == 50


#TEST - january = { income:[100], expenses:[50] }
#TEST - february = { income:[300], expenses:[200] }
#TEST - march = { income:[200], expenses:[50] }
